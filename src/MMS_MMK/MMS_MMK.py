...
FileName = './src/MMS_MMK/InputData.dat'
...
class MMS_MMK():
    ...
    def forIter(self, indexMax):
        ...
        Bi = self.ParameterDict['K'][indexMax] / self.ParameterDict['W'][indexMax] * \
            self.ParameterDict['MU'][indexMax] * (1 - 1 / self.N) 
